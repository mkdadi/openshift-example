![Semantic](//www.semantic-ui.com/images/logo.png)
...
For details on how work with Semantic theming please [read our customization guide](//learnsemantic.com/developing/customizing.html) on [LearnSemantic.com](//learnsemantic.com/)
...
[EmberJS](//emberjs.com/) | `ember install:addon semantic-ui-ember` | [Ember Repo](https://github.com/Semantic-Org/Semantic-UI-Ember)
...
[Bower](//bower.io/) | `bower install semantic-ui` | 
...
* **Chinese** A Chinese mirror site is available at [//www.semantic-ui.cn](//www.semantic-ui.cn)
...
--- | --- |
Bugs & Feature Requests |  All bug submission **require** a link to a test case, and a set of steps to reproduce the issue. You can make a test case by forking this [jsfiddle](//jsfiddle.net/efp8z6Ln/), then submit your [bug report on GitHub Issues](https://github.com/Semantic-Org/Semantic-UI/issues)
Live Chat | Join our [Gitter.im Room](https://gitter.im/Semantic-Org/Semantic-UI)
Newsletter Updates | Sign up for updates at [semantic-ui.com](//www.semantic-ui.com)
Additional Resources  | Submit a question on [StackOverflow](//www.stackoverflow.com) or ask our [Google Group](https://groups.google.com/forum/#!forum/semantic-ui)
...
[SCSS](//sass-lang.com/) | SASS needs PR to support variables inside `@import` | [Add Pull Request](https://github.com/sass/sass/pulls) for [#739](https://github.com/sass/sass/issues/739#issuecomment-73984809)
...
When adding pull requests be sure to merge into [next](https://github.com/Semantic-Org/Semantic-UI/tree/next) branch. If you need to demonstrate a fix in ``next`` release, you can use [this jsfiddle](//jsfiddle.net/rduvhn8u/1/)
...
<a href="//packagequality.com/#?package=semantic-ui"><img src="//npm.packagequality.com/badge/semantic-ui.png"/></a>
